...
%     flp_path = "data/approx/QAM64/log_flp_nofec_qam" + modul + "/log_data.txt";
    ...
    semilogy(y_flp(:,1), y_flp(:,2) + eps, ...
        ...
        "DisplayName", "FLP Base, without FEC");
    hold on;
...
%     idx_1 = find(refdata.Modulation == modul & refdata.LDPC_Iter == 50);
    ...
    semilogy(y_flp(:,1), y_flp(:,2) + eps, ...
        "--x", "MarkerSize", 7, ...
        "MarkerFaceColor", orange_red, "Color", orange_red,...
        "DisplayName", "FLP Base, LDPC (50 Iter)");
    hold on;
    ...
    semilogy(y_fxp_1(:,1), y_fxp_1(:,2) + eps, ...
        "--square", "MarkerSize", 6, ...
        "Color", navy_blue,...
        "DisplayName", fxp + " Base MUL32, without FEC");
    hold on;
    ...
    semilogy(y_fxp_2(:,1), y_fxp_2(:,2) + eps, ...
        "-.v", "MarkerSize", 6, ...
        "Color", steel_blue,...
        "DisplayName", fxp + " Approx MUL32, without FEC");
    hold on;
    ...
    semilogy(y_fxp_3(:,1), y_fxp_3(:,2) + eps, ...
        ...
        "Color", navy_blue,...
        "DisplayName", fxp + " Base MUL32, LDPC (" + iter + " Iter)");
    hold on;
    ...
    semilogy(y_fxp_4(:,1), y_fxp_4(:,2) + eps, ...
        "-.^", "MarkerSize", 6, ...
        "Color", steel_blue,...
        "DisplayName", fxp + " Approx MUL32, LDPC (" + iter + " Iter)");
    hold on;
